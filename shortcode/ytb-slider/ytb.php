        ...
        <?php if (!empty($list_content["id"][0])) :; ?>
            <div class="ytb-iframe">
                <div class="ytb-iframe-inner">
                    <iframe src="https://www.youtube.com/embed/<?php echo $list_content["id"][0]; ?>" title="<?php echo $list_content["title"][0]; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="swiper-wrapper" direction="vertical" slides-per-view="auto">
                <?php for ($index = 0; $index < count($list_content["id"]); $index++) :; ?>
                    <?php if (!empty($list_content["id"][$index])) :; ?>
                        <div class="swiper-slide ytb-thumb <?php if ($index == 0) echo "active"; ?>" data-id="<?php echo $list_content["id"][$index]; ?>" data-index="<?php echo $index; ?>" data-title="<?php echo $list_content["title"][$index]; ?>">
                            <div class="ytb-thumb-inner">
                                <div class="ytb-thumb-icon" style="background-image:url(&quot;https://img.youtube.com/vi/<?php echo $list_content["id"][$index]; ?>/mqdefault.jpg&quot;)"></div>
